...
## Abstract
We developed an interest point detector to detect interest point location for **event camera data**. The idea was adapted from the literature *"SuperPoint: Self-Supervised Interest Point Detection and Description."*[1]
